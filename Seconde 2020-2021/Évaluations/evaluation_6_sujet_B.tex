...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item \og{}on obtient une consonne\fg{} ;\rep{5}
    \item \og{}on obtient une lettre du mot \textsc{KARATÉ}\fg{} ;\rep{5}
...
\begin{enumerate}
  \item Aaron loue un vélo et l'utilise pendant $2$ heures. Combien paiera-t-il la location ?\rep{5}
  \item Mihiau loue un vélo pendant $5$ heures. Combien paiera-t-elle la location ?\rep{5}
