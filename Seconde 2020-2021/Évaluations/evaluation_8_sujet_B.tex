...
\begin{enumerate}
  \item Écrire $\sqrt{275}$ sous la forme $a\sqrt{b}$, où $a$ est un entier et $b$ l'entier naturel le plus petit possible.\rep{6}
  \item Écrire $\dfrac{4}{\sqrt{7}-1}$ sans racine carrée au dénominateur.\rep{6}
  \item Donner une valeur arrondie de $\dfrac{19}{\sqrt{7}}$ à $10^{-4}$ près.\rep{4}
\end{enumerate}
...
\begin{itemize}
  \item pour un article coûtant moins de \np{8500} XPF, une remise de $30\%$ est effectuée ;
  \item pour un article coûtant \np{8500} XPF ou plus, une remise de $20\%$ est effectuée.
\end{itemize}
\begin{enumerate}
