...
\begin{enumerate}
  \item Représenter les droites $\mathcal{D}$, $\mathcal{D}_1$ et $\mathcal{D}_2$.\rep{12}
  ...
  \item Déterminer deux équations cartésiennes de $\mathcal{D}$.\rep{5}
\end{enumerate}
